...
export const UpdateProfile = () => {
    ...
    const profileSubmitHandler=async(event)=>{
        ...
        try{
       const res = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyAULICMLkKpLi7eJ9CIrBXM3fvXPmVHqoA',{
        method : 'POST',
        body :JSON.stringify({
  ...
  return (
    <div>
        <div className='main-update-profile'>
            ...
            <div className='profile-update'>Your Profile is 64% complete . A complete Profile has <br/>higher chances of landing a job </div>
        </div>
